...
class BookLoader(UnstructuredFileLoader):
    ...
    def __init__(self, file_path: Union[str, List[str], Path, List[Path], None], book_name: str,
    ...
    def _get_elements(self) -> List:
        ...
        return partition_epub(filename=self.file_path, **self.unstructured_kwargs, metadata_filename=self.book_name)
